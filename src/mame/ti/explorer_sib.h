...
private:
	...
	u32 m_attribute_register;
	u32 m_mask_register;
	u32 m_operation_register;
	u32 m_mouse_y_position;
	u32 m_mouse_x_position;
	u8 m_mouse_keyswitches;
	int m_keyboard_txd;
	bool m_mouse_motion_event_pending;
	bool m_mouse_keyswitch_event_pending;
	u32 m_interrupt_diag_control;
	u32 m_monitor_control;
	u32 m_diagnostic_data;
	u32 m_voice_data_register;
	bool m_voice_data_present;
	u32 m_printer_data;
	u32 m_printer_control;
	u8 m_centronics_busy;
	u8 m_centronics_perror;
	u8 m_centronics_select;
	u8 m_centronics_fault;
	u8 m_centronics_ack;
	u32 m_sound_control;
	u32 m_speech_register;
	bool m_usart_rxrdy;
	bool m_usart_txrdy;
};
