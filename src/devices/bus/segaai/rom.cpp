...
u8 segaai_rom_128_device::read_cart(offs_t offset)
{
	return m_rom[offset];
}

void segaai_rom_128_device::write_cart(offs_t offset, u8 data)
{
}
...
u8 segaai_rom_256_device::read_cart(offs_t offset)
{
	offset &= 0xffff;
...
void segaai_rom_256_device::write_cart(offs_t offset, u8 data)
{
