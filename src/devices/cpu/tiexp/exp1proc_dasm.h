...
#ifndef MAME_CPU_TIEXP_EXP1PROC_DASM_H
#define MAME_CPU_TIEXP_EXP1PROC_DASM_H

#pragma once

class exp1proc_disassembler : public util::disasm_interface
{
public:
	exp1proc_disassembler() = default;
	virtual ~exp1proc_disassembler() = default;
